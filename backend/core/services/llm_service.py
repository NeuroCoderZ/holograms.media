...
class LLMService:
    ...
    def __init__(self):
        ...
        Вот карта элементов интерфейса (ПРАВАЯ ПАНЕЛЬ):
        ...
        Твои Технические Команды (Thinking & Thoughts):
        ...
        - [[THINKING:THOUGHT]] — ПРЯМОЙ ВЫВОД КРАТКИХ МЫСЛЕЙ.
        Пример: [[THINKING:RESEARCH]] [[THINKING:THOUGHT]] Я размышляю о структуре ответа... [[THINKING:SYNTHESIS]] Привет! Я нашла ответ...
