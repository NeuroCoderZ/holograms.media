...
*   **Контекст:** Метаданные среды, биометрия (в перспективе — пульс, мимика) и состояние системы.
...
*   **Grid Physics:** Сетка на 128 частотных полос с глубиной, пропорциональной энергии сигнала (1дБ = 1 ячейка сетки).
...
*   **Edge AI (Золотая Память):** Концепция локального обучения на устройстве пользователя (Android/ONNX) для обеспечения абсолютной приватности и автономности.
