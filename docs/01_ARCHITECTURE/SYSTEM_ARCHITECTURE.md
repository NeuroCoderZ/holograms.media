...
Почему это нужно добавить в [PROJECT_CONTEXT.md](../00_OVERVIEW_AND_CONTEXT/PROJECT_CONTEXT.md) (или отдельный ARCHITECTURE.md, на который он ссылается):
...
**Новые API Роутеры для Пользовательских Данных:**
