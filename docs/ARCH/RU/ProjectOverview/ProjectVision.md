...
- **BasilaQ-128 Physics:** 1дБ = 1 ячейка сетки. Смещение по X зафиксировано: **1.41°** (180° / 128 ячеек). Плавность только визуальная.
- **Инфраструктура:** FastAPI на Koyeb + Astra DB (3072d эмбеддинги).
- **Интерфейс:** Консолидация управления (Микрофон, Жесты, Голограммы) в **Правой панели**.
- **Синхронизация:** Обмен голограммами через WebRTC P2P + WebSocket-сигналинг (dev.holograms.media).
