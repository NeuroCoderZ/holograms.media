...
# --- API Ключи ---
export OPENROUTER_API_KEY="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" # Для OpenRouter
export MISTRAL_API_KEY="MISTRAL_API_KEY_REDACTED" # Для Mistral API
