...
export class HoloEngine {
    ...
    _setupCameras() {
        ...
        // Столбцы: Y от -128 до -1, сетки: Y от 0 до 256
        // Видим область: X: -140..140, Y: -140..10, Z: 0..160
        this.orthoProjection = this._ortho(-140, 140, -140, 10, 0.1, 300);

        // Перспективная камера (XR режим)
        this.perspectiveProjection = this._perspective(Math.PI / 4, 1.6, 0.1, 300);

        // Позиция камеры: смотрим на центр столбцов (0, -64, 0)
